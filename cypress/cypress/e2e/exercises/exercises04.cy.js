describe('Exercises 04', () => {
     ...
     */
    let expectedValueName = 'Leanne Graham'

    it(`should return ${expectedValueName} when requesting data for user with ID 1`), () =>{
        cy.request({
            method: "GET",
            ...
            expect(response.name).to.eq(expectedValueName)
        })
    }
     ...
     */
    it('should post the correct data to the header'), () => {
